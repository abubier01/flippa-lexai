// app/api/admin/migrate-tickets/__tests__/route.test.ts
...
describe('POST /api/admin/migrate-tickets', () => {
  it('returns 403 immediately when requireAdminAccess denies access', async () => {
    ...
    const request = new Request('http://localhost/api/admin/migrate-tickets', { method: 'POST' })
